...
$vpstring      = json_decode($twitter->setGetfield($vpgetfield)->buildOauth($url, $requestMethod)->performRequest(), $assoc = TRUE);
...
$requestMethod           = 'GET';
$twitter                 = new TwitterAPIExchange($settings);
$realDonaldTrumpstring   = json_decode($twitter->setGetfield($realDonaldTrumpgetfield)->buildOauth($url, $requestMethod)->performRequest(), $assoc = TRUE);
...
$requestMethod = 'GET';
$twitter       = new TwitterAPIExchange($settings);
$potusstring   = json_decode($twitter->setGetfield($potusgetfield)->buildOauth($url, $requestMethod)->performRequest(), $assoc = TRUE);
...
$data = array(
    ...
    'rdtlink' => $rdtlink,
    'vplink' => $vplink,
    'potusclose' => $json_potusclose,
    'rdtclose' => $json_rdtclose,
    'vpclose' => $json_vpclose
);
