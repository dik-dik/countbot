...
<style>body{font-family:"Comic Sans MS",sans-serif;text-align:center}h2{color:#f441be}h3{color:green}a{text-decoration:none}a.title:link,a.title:visited{color:#4286f4}a.thecount:link,a.thecount:visited{color:green}a.thecount:hover,a.title:hover{color:#a8088d}div.blok{padding:0 0 10px;display:inline-block;width:20em}div#whole{text-align:center;float:center}.nomobile{display:none}@media screen and (min-width: 768px){.nomobile{clear:both;display:block}}</style>
</head>
...
<div align=right>
	<a href="advanced.php">even more bullshit stats</a>
</div>
</body>
</html>